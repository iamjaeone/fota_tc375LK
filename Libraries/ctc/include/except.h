 ...
 */
#define EFINVOP         (1 << 6)                /* invalid operation, for instance 0.0/0.0, 0.0*Inf or on a NaN */
#define EFDIVZ          (1 << 4)        /* division by zero, for instance 12.5/0.0 (not 0.0/0.0)    */
#define EFOVFL          (1 << 5)                /* overflow, when the result of an operation is too large       */
#define EFUNFL          (1 << 3)        /* underflow,when the result of an operation is too small       */
#define EFINEXCT        (1 << 2)
#define EFALL           (EFINVOP|EFDIVZ|EFOVFL|EFUNFL|EFINEXCT) /* the combination of all the above enlisted exceptions */
