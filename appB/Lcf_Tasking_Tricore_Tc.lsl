...
#define LCF_INTVEC0_START 0x805FA000
#define LCF_INTVEC1_START 0x805FC000
#define LCF_INTVEC2_START 0x805FE000

#define LCF_TRAPVEC0_START 0x805F9F00
#define LCF_TRAPVEC1_START 0x805F9E00
#define LCF_TRAPVEC2_START 0x805F9D00

#define LCF_STARTPTR_CPU0 0x80300000
#define LCF_STARTPTR_CPU1 0x80300020
#define LCF_STARTPTR_CPU2 0x80300040

#define LCF_STARTPTR_NC_CPU0 0xA0300000
#define LCF_STARTPTR_NC_CPU1 0xA0300020
#define LCF_STARTPTR_NC_CPU2 0xA0300040
...
derivative tc37
{
    ...
    section_layout :vtc:linear
    {
        ...
        group (ordered)
        {
            ...
            group  interface_const (run_addr=mem:pfls1[0x0020])
            {
...
#        endif
        ...
        group
        {
            group (ordered, align = 4, contiguous, run_addr=mem:pfls1)
            {
