...
#define _IORD           ((_iob_flag_t)0x01)     /* file is open for reading */
#define _IOWR           ((_iob_flag_t)0x02)     /* file is open for writing */
#define _IOFBF          ((_iob_flag_t)0x00)     /* fully buffered (not a flag!) */
#define _IONBF          ((_iob_flag_t)0x04)     /* unbuffered */
#define _IOLBF          ((_iob_flag_t)0x08)     /* line buffered */
#define _IOBUF          (_IOFBF|_IONBF|_IOLBF)  /* buffering flags */
#define _IOMYBUF        ((_iob_flag_t)0x10)     /* must be freed after use */
#define _IOEOF          ((_iob_flag_t)0x20)     /* end of file indicator for feof() */
#define _IOERR          ((_iob_flag_t)0x40)     /* error indicator for ferror() */
#ifdef WCHAR_SUPPORT_ENABLED
#define _IOCHAR         ((_iob_flag_t)0x80)     /* stream is byte oriented */
#define _IOWCHAR        ((_iob_flag_t)0x100)    /* stream is wide-char oriented */
#endif
