...
#pragma nomisrac 1,13,14,93,96,114,115,124
#elif __MISRAC_VERSION__ == 2004
#pragma nomisrac 1.1,6.3,19.4,19.7,20.1,20.2,20.9
#elif __MISRAC_VERSION__ == 2012
#pragma nomisrac 1.2,2.5,8.2,8.14,17.1,21.1,21.2
#endif
