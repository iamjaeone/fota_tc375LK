...
#define LCF_INTVEC0_START 0x802FF000
#define LCF_INTVEC1_START 0x802FE000
#define LCF_INTVEC2_START 0x802FD000

#define LCF_TRAPVEC0_START 0x80020100
#define LCF_TRAPVEC1_START 0x80020200
#define LCF_TRAPVEC2_START 0x80020300

#define LCF_STARTPTR_CPU0 0x80020000
#define LCF_STARTPTR_CPU1 0x80020020
#define LCF_STARTPTR_CPU2 0x80020040

#define LCF_STARTPTR_NC_CPU0 0xA0020000
#define LCF_STARTPTR_NC_CPU1 0xA0020020
#define LCF_STARTPTR_NC_CPU2 0xA0020040
...
derivative tc37
{
    ...
    {
        mau = 8;
        size = 3M-BOOTLOADER_SIZE;
        type = rom;
        map     cached (dest=bus:sri, dest_offset=0x80020000,           size=3M-BOOTLOADER_SIZE);
        map not_cached (dest=bus:sri, dest_offset=0xa0020000, reserved, size=3M-BOOTLOADER_SIZE);
    }
